 ...
 */
public class servicio_llamada_aceptado extends FragmentActivity implements OnMapReadyCallback, GoogleMap.CancelableCallback{
    Context ctx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.servicio_llamada_aceptado);
        ctx = this;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success==1){
                                ...
                                Intent i = new Intent(ctx, servicio_llamada_transportando.class);
    ...
    Runnable runnableMap = new Runnable() {
        ...
        public void run() {
            ...
            if(estado_pedido>5) {
                ...
                Intent i = new Intent(ctx, servicio_llamada_anulado.class);
                i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(i);
                finish();
