 ...
 */
public class servicio_amb_transportando extends FragmentActivity implements OnMapReadyCallback, GoogleMap.CancelableCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.servicio_amb_transportando);
        ctx = this;
        ...
        btn_finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ctx, servicio_amb_finalizar.class);
