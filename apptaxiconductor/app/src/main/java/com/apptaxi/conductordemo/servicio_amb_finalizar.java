 ...
 */
public class servicio_amb_finalizar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.servicio_amb_finalizar);
        ctx = this;
    ...
    private void FinalizarServicio() {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST,
                global.UrlServer + global.UL0009_2,
    ...
    private void CargarRecorridoServicio() {
        progress.show();
        StringRequest sr = new StringRequest(Request.Method.POST,
                global.UrlServer + global.UL0008_2,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progress.dismiss();
