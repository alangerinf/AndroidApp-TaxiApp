 ...
 */
public class servicio_llamada_finalizar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.servicio_llamada_finalizar);
        ctx = this;
        ...
        progress.setMessage("Aplicando precio");
    ...
    private void FinalizarServicio() {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST,
                global.UrlServer + global.UL0009_1,
    ...
    private void CargarRecorridoServicio() {
        progress.show();
        StringRequest sr = new StringRequest(Request.Method.POST,
                global.UrlServer + global.UL0008_1,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progress.dismiss();
