 ...
 */
public class servicio_app_transportando extends FragmentActivity implements OnMapReadyCallback, GoogleMap.CancelableCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.servicio_app_transportando);
        ctx = this;
        ...
        if(latDestino!=0 && lngDestino!=0) {
            txt_destino.setVisibility(View.VISIBLE);
            txt_destino.setText("DESTINO: " + destino);
        }else{
            txt_destino.setVisibility(View.INVISIBLE);
        }
